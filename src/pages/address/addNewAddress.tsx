    ...
    return(
        <div>
            <div className="w-full h-64 bg-mainBlue">
                <img src={MapSvg} className="w-full h-80 object-cover" />
            </div>
            <div className="bg-gray-100 fixed mt-10 inset-x-0 bottom-[0rem] w-full height:auto py-5 pb-10 border-t-2xl rounded-t-[36px] px-5">
