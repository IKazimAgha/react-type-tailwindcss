...
import Navbar from '../navBar/noBGNav';
...
const RouteDetails = () => {
    ...
    return (
        <>
            <GoogleMapComponent />
            <div className='absolute top-0 z-10 w-full bg-none'>
                <Navbar title='' onClickArrow={() => navigate('/routeStatus')} isFilterIcon={true} />
            </div>
            <div className=" border-2 h-1/2 rounded-tl-3xl rounded-tr-3xl bg-white border-white px-2 absolute bottom-0">
